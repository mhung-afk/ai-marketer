...
# Try to get account ID from STS if not set in environment
if not AWS_ACCOUNT_ID:
    try:
        ...
        AWS_ACCOUNT_ID = ""  # Fall back to empty if STS call fails
